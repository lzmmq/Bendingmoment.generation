...
###  Let set: Truck type = 5, bridgeL = 100(m), velocity = 50(m/s), Observation = 50 Hz, Noise level = 0%. So when trcuk drives through this bridge, the bending moment generated at midspan will be a sequence in 2s, every 0.02s, we will record once.

#### Unpolluted Bending moment of #5 truck under data within 2 s. 
...
```
### Let set: Truck type = 5, bridgeL = 100(m), velocity = 50(m/s), Observation = 50 Hz, Noise level = 0%, 10%, 15%, 20%.

#### Bending moment of #5 truck under data. 
...
### Let set: Truck type = 1,3,5,8, bridgeL = 100(m), velocity = 50(m/s), Observation = 50 Hz, Noise level = 0%.

#### Bending moment of 4 types of  truck under 1% level noise 
